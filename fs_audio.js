...
class Audio {
  constructor(opts) {
    ...
    var fs = fs_audio(opts)
    fs._audioInit()

    // fssynth methods
    this._notesProcessing = fs._notesProcessing
    this._playWorklet = fs._playWorklet
  }
...
/***********************************************************
    Fields.
************************************************************/
var fs_audio = function (opts) {
  var _fps = opts._fps
  var _canvas_height = opts._canvas_height
  var _notification = opts._notification
  ...
  var _FS_WORKLET = 0,
      ...
      _notes_worker = new Worker("public/worker/notes_buffer.js"),
  ...
  ************************************************************/
  ...
  var _workletReady = function (wnode) {
     _notification('worklset ready', wnode)
  ...
  var _connectWorklet = function () {
    console.log('worklet', _fragment_worklet_node, _osc_mode)
  ...
  ************************************************************/
  ...
  var _audioInit = function () {
      ...
      //         "    }" +
      //         "}" +
      //         "audio_ctx.audioWorklet.addModule('public/worker/fragment_worklet.js').then(() => {" +
  ...
  return {
    _audioInit: _audioInit,
    _notesProcessing: _notesProcessing,
    _playWorklet: _playWorklet
  }
}
